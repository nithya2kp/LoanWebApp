    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('csv_file_url', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PENDING', 'Pending'), ('APPROVED', 'Approved'), ('REJECTED', 'Rejected')], default='PENDING', max_length=20)),
                ('loan_application', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='loan_payments', to='user.loanapplication')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payments', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='credit_evaluation', to='user.payment')),
            ],
            options={
                'abstract': False,
            },
